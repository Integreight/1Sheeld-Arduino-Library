...
void SevSegShieldClass::setSeg(int x)
{
	...
	switch (x)
	{
		case 0 : OneSheeld.sendPacket(SEV_SEG_ID,SET_SEG,1,new FunctionArg(1,ptr));break;
		case 1 : OneSheeld.sendPacket(SEV_SEG_ID,SET_SEG,1,new FunctionArg(1,ptr+1));break;
		case 2 : OneSheeld.sendPacket(SEV_SEG_ID,SET_SEG,1,new FunctionArg(1,ptr+2));break;
		case 3 : OneSheeld.sendPacket(SEV_SEG_ID,SET_SEG,1,new FunctionArg(1,ptr+3));break;
		case 4 : OneSheeld.sendPacket(SEV_SEG_ID,SET_SEG,1,new FunctionArg(1,ptr+4));break;
		case 5 : OneSheeld.sendPacket(SEV_SEG_ID,SET_SEG,1,new FunctionArg(1,ptr+5));break;
		case 6 : OneSheeld.sendPacket(SEV_SEG_ID,SET_SEG,1,new FunctionArg(1,ptr+6));break;
		case 7 : OneSheeld.sendPacket(SEV_SEG_ID,SET_SEG,1,new FunctionArg(1,ptr+7));break;
		case 8 : OneSheeld.sendPacket(SEV_SEG_ID,SET_SEG,1,new FunctionArg(1,ptr+8));break;
		case 9 : OneSheeld.sendPacket(SEV_SEG_ID,SET_SEG,1,new FunctionArg(1,ptr+9));break;
...
void SevSegShieldClass::setCustomChar(char shape)
{
	...
	OneSheeld.write(SEV_SEG_ID,SET_CHAR,dataptr,1);
