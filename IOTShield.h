...
public:
  ...
  void publish(const char *, int , byte=0,byte=0);
  void publish(const char *, unsigned int,byte=0,byte=0);
  void publish(const char *, float ,byte=0,byte=0);
  void publish(String, String,byte=0,byte=0);
  void publish(String, byte *,byte ,byte=0,byte=0);
  void publish(String, int , byte=0,byte=0);
  void publish(String, unsigned int,byte=0,byte=0);
  void publish(String, float ,byte=0,byte=0);
